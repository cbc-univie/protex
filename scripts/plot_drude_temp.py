...
freqs = ["~/software/protex_data/scripts/data/drude_temp_1_d20.out","~/software/protex_data/scripts/data/drude_temp_1_d40.out","~/software/protex_data/scripts/data/drude_temp_1_d80.out","~/software/protex_data/scripts/data/drude_temp_1_d100.out", "~/software/protex_data/scripts/data/drude_temp_1_d120.out", "~/software/protex_data/scripts/data/drude_temp_1_d140.out","~/software/protex_data/scripts/data/drude_temp_1_d160.out"]
print(freqs)
