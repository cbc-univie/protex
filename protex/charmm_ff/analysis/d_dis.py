...
if args.insidebash:
    ...
    base = path.parent
    try:
        psf_generator = base.glob("*_xplor.psf")
    ...
    base="/site/raid1/florian/conductivity/mix_40_60/lj04/rep1/"
    psf = base + "im1h_oac_200_im1_hoac_300_nvt.psf"
    dcd_base = "/traj/polarizable_nvt/im1h_oac_200_im1_hoac_300_"
