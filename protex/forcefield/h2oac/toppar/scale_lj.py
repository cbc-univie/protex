...
stream_file2 = read_file("oac_dummy_d.str")
stream_file3 = read_file("im1_dummy_d.str")
stream_file4 = read_file("hoac_d.str")
stream_file5 = read_file("tfa_d.str")
stream_file6 = read_file("htfa_d.str")
stream_file7 = read_file("hpts_dummy_d_chelpg.str")
stream_file8 = read_file("hptsh_d_chelpg.str")
...
atomtypes = read_atomtypes(big_file, "IM1H", "OAC", "IM1", "HOAC", "TFA", "HTFA", "hpts", "hptsh")
#print(atomtypes)
