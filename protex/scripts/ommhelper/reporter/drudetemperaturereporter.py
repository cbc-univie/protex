...
class DrudeTemperatureReporter(object):
    ...
    def report(self, simulation, state):
        ...
        print(
            ...
            t_com.value_in_unit(kelvin),
            t.value_in_unit(kelvin),
            t_drude.value_in_unit(kelvin),
            ke_com.value_in_unit(kJ_mol),
            ke.value_in_unit(kJ_mol),
            ke_drude.value_in_unit(kJ_mol),
            sep="\t",
            file=self._out,
        )
